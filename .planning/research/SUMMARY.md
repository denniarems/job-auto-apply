...
- **AI & Data:** **Vercel AI SDK** for model-agnostic routing; **LanceDB** for embedded local vector storage.
...
1. **Phase 1: Local Foundation & Extension Plumbing**
   ...
   - **Deliverables:** Hono server with LanceDB integration, WXT extension scaffold, and secure message passing.
...
**Gaps to Address:**
- **LanceDB Maturity:** LanceDB is well-maintained and cross-platform; implementation should verify performance with >1000 embeddings.
